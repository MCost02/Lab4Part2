...
function setComment($id) {
    ...
    $.ajax({
        ...
        // Displays message after succesfully posting comment
        success: function (data) {
...
function addToCart($id) {
    ...
    if (email == '') {
        alert('Please enter your e-mail at the top of the page.')
        return;
    }
    ...
    $.ajax({
        ...
        // Displays message after succesfully adding an item to shopping cart
        success: function (data) {
